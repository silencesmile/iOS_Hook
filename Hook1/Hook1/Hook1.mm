...
//  Hook1
//
//  Created by youngstar on 2017/6/22.
...
CHDeclareClass(TalkerTest); // declare class

CHMethod(1, void, TalkerTest, say, id, arg1)
{
    NSString *tmp = @"已经被hook";
    
    CHSuper(1, TalkerTest, say, tmp);
}

__attribute__ ((constructor)) static void entry()
{
    CHLoadLateClass(TalkerTest);
    CHClassHook(1, TalkerTest, say);
}

//@interface Hook1 : NSObject
//
//@end
//
//@implementation Hook1
//
//-(id)init
//{
//	if ((self = [super init]))
...
//		// this would be posted using: notify_post("Young.Hook1.eventname");
//		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
//		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("Young.Hook1.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
//		
